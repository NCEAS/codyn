...
test_that("temporal_torus_translation loads and returns correct result", {
  ...
  myresults<-temporal_torus_translation_CI(dat1, replicate.var=NA, species="species", year="year", abundance.var="abundance", FUN=calVR, bootnumber=2, li=0.025, ui=0.975, averagereps=FALSE)
  
  #Test that returns an error when abundance is a character or factor column
  expect_error(temporal_torus_translation_CI(knz_001d2, replicate.var="sub", species="sp", year="yr", abundance.var="randcharacter", FUN=calVR, bootnumber=2, li=0.025, ui=0.975, averagereps=FALSE))
  expect_error(temporal_torus_translation_CI(knz_001d2, replicate.var="sub", species="sp", year="yr", abundance.var="randfactor", FUN=calVR, bootnumber=2, li=0.025, ui=0.975, averagereps=FALSE))
  ...
  myresults2<-temporal_torus_translation_CI(dat1, replicate.var="subplot", species="species", year="year", abundance.var="abundance", FUN=calVR, bootnumber=2, li=0.025, ui=0.975, averagereps=FALSE)
  expect_that(is.factor(myresults2$subplot), equals(TRUE))
  
  myresults2b<-temporal_torus_translation_CI(dat3, replicate.var="subplot", species="species", year="year", abundance.var="abundance", FUN=calVR, bootnumber=2, li=0.025, ui=0.975, averagereps=FALSE)
  ...
  myresults2b<-temporal_torus_translation_CI(knz_001d, replicate.var="subplot", species="species", year="year", abundance.var="abundance", FUN=calVR, bootnumber=2, li=0.025, ui=0.975, averagereps=FALSE)
  
  #Test that is correct for whether "averagereps" is true or false
  dat5<-dat4
  dat5$subplot<-as.character(dat5$subplot)
  myresults3<-temporal_torus_translation_CI(dat5, replicate.var="subplot", species="species", year="year", abundance.var="abundance", FUN=calVR, bootnumber=2, li=0.025, ui=0.975, averagereps=TRUE)
  myresults4<-temporal_torus_translation_CI(dat5, replicate.var="subplot", species="species", year="year", abundance.var="abundance", FUN=calVR, bootnumber=2, li=0.025, ui=0.975, averagereps=FALSE)
  ...
  myresults4<-temporal_torus_translation_CI(knz_001d, replicate.var="subplot", species="species", time.var="year", abundance.var="abundance", FUN=calVR, bootnumber=2, li=0.025, ui=0.975, averagereps=TRUE)
  expect_that(nrow(myresults4), equals(1))
  myresults5<-temporal_torus_translation_CI(knz_001d, replicate.var="subplot", species="species", time.var="year", abundance.var="abundance", FUN=calVR, bootnumber=2, li=0.025, ui=0.975, averagereps=FALSE)
