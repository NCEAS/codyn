...
test_that("community_stability loads and returns correct result", {
  ...
  myresults3<-community_stability(dat1, replicate=NA, year="year", abundance="abundance")
  ...
  myresults4<-community_stability(dat1, replicate="subplot", year="year", abundance="abundance")
  ...
  myresults6<-community_stability(dat3, replicate="subplot", year="year", abundance="abundance")
  expect_that((myresults6[1,2]), equals(myresults3))  
  
  #test that works with multiple replicates
  myresults7<-community_stability(knz_001d, replicate="subplot", year="year", abundance="abundance")
