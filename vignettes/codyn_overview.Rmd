...
- **`mean_rank_shift`** quantifies relative changes in species rank abundances by taking the sum difference of species ranks in consecutive timepoints. This metric goes hand-in-hand with "rank clocks," a useful visualization tool for shifts in species ranks. 
