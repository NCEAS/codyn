...
```{r results='asis'}
KNZ_synchrony <- synchrony(df = knz_001d, 
                         time.var = "year", 
                         species.var = "species", 
                         abundance.var = "abundance", 
                         replicate.var = "subplot")
...
```{r results='asis'}
KNZ_A1_synchrony <- synchrony(df = subset(knz_001d, subplot=="A_1"),
                            time.var = "year",
                            species.var = "species", 
                            abundance.var = "abundance")
KNZ_A1_synchrony
...
```{r results='asis'}
KNZ_synchrony_2 <- synchrony(df = knz_001d, 
                           time.var = "year", 
                           species.var = "species",  
                           abundance.var = "abundance", 
                           metric = "Gross", 
...
If there are no replicates within the dataset allow the `replicate.var` argument to default to `NA`. 
```{r results='asis'}
KNZ_A1_synchrony_2 <- synchrony(df = subset(knz_001d, subplot=="A_1"),
                              time.var = "year", 
                              species.var = "species",  
                              abundance.var = "abundance", 
                              metric = "Gross")
