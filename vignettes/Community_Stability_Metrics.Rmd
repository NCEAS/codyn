...
- `cyclic_shift`  returns the output of a user-specified function when applied to a null community for functions that require a species x time matrix.

- `confint` returns the confidence intervals for a user-specified function that returns a single-value test statistic and requires a species x time matrix.
