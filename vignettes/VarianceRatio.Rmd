...
```{r results='asis'}
KNZ_varianceratio<-varianceratio(df=KNZ, replicate.var="subplot", species.var="species", time.var="year", abundance.var="abundance", bootnumber=10)
...
```{r results='asis'}
KNZ_varianceratio_avgrep<-varianceratio(df=KNZ, replicate.var="subplot", species.var="species", time.var="year", abundance.var="abundance",  bootnumber=10, average.replicates=FALSE)
...
```{r results='asis'}
KNZ_A1<-subset(KNZ, subplot=="A_1")
KNZ_A1_varianceratio<-varianceratio(df=KNZ_A1, replicate.var=NA, species.var="species", time.var="year", abundance.var="abundance",  
                                 bootnumber=10) 
