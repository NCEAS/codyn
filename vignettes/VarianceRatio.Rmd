...
##Data 
To illustrate each function, we will use a grassland species composition data from the Konza Prairie Long-term Ecological Research site in Manhattan, KS.
```{r results='asis', eval=FALSE}
KNZ <- count.fields(system.file("extdata", 
                            "knz_001d.csv", 
                            package="codyn"), 
                sep=",",
                header=TRUE,
                colClasses=c(NA, NA, NA, NA, 'NULL', NA, NA))
kable(head(KNZ))
```
