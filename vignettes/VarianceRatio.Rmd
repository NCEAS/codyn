...
**`variance_ratio`** which characterizes species covariance (Schluter 1984, Houlahan et al. 2007), and includes a null-modeling approach to test significance (Hallett et al. 2014).

**`synchrony`** which compares the variance of the aggregated community with the variance of individual components (Loreau and de Mazancourt 2008).
